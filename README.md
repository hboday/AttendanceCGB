...
11. Then, run the command “rails db:drop”
12. Then, run the command “rails db:migrate”
13. Then, run the command “rails db:seed” 
14. Then run, “yarn add sass” 
15. Then run, “yarn add esbuild” 
16. Then run, "yarn add stimulus-flatpickr@beta"
17. Then run, “bin/dev” to run the server
